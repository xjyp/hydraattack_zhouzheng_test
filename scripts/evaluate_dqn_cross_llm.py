...
"""
DQN跨LLM泛化评估脚本
加载在Qwen3-8B作为judge情况下训练的DQN模型，测试攻击Qwen3-0.6B的效果
"""
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description="DQN跨LLM泛化评估")
    ...
    logger.logger.info("🚀 开始DQN跨LLM泛化评估")
    ...
    results_file = os.path.join(args.output_dir, f"cross_llm_evaluation_{args.benchmark}_{timestamp}.json")

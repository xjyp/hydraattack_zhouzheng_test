...
"""
PPO跨数据集泛化评估脚本
加载在一个benchmark上训练的PPO模型，在另外两个benchmark的测试集上进行测试
"""
...
def main():
    ...
    logger.logger.info("🚀 开始PPO跨数据集泛化评估")
    ...
    results_file = os.path.join(args.output_dir, f"ppo_cross_benchmark_evaluation_{args.source_benchmark}_to_{args.target_benchmark}_{timestamp}.json")
